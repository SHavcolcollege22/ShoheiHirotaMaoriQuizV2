...
// Do all of this in a while loop
  ...
  // If levelDifficulty == 'easy'
    // Foreach (string MaoriTermaEasy in maoriTermEasy)
      // What is the english translation of {maoriTermEasy[indexEasy] + maoriOptionsEasy[indexEasy]}
        // If answer == englishTermsEasy[indexEasy]
           // Print correct (and add one to the score count (scoreEasy++))
        // Else
           // Print incorrect
        // Add one the the index (indexEasy++)
